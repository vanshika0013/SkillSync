  ...
  return (
    <div className="login-page">
      <div className="left-panel">
        <div className="logo">
          <span className="logo-icon"> &lt;/&gt; </span>SkillSync
        </div>

        <div className="hero-content">
          <h1 className="hero-heading">
            Your learning journey <br />{" "}
            <span className="hero-span">starts here</span>
          </h1>
          <p>
            Small steps today,<br />
            <span>great skills</span> tomorrow
          </p>
        </div>

        <div className="journey-timeline">

          <img src={wave} className="timeline-wave" alt="" />
      ...
      <div className="right-panel">
        <div className="login-card">
          ...
          <form className="login-form" onSubmit={handleSubmit}>
            ...
            <button type="submit" className="continue-learning">
              Continue Learning
            </button>
